                      ...
                      <div className="flex flex-wrap gap-2 mt-3">
                        {templates.filter(t => t.id !== 'custom').slice(0, 3).map((template) => (
                          <button
                            ...
                            className="flex items-center gap-2 px-3 py-1.5 text-sm font-medium bg-white dark:bg-neutral-800 border border-white/10 rounded-lg hover:border-neutral-500 hover:bg-neutral-800/50 transition-colors disabled:opacity-50"
                          >
                            {quickSetupLoading ? (
          ...
          <div className="relative text-center space-y-6">
            ...
            <div className="relative w-24 h-24 mx-auto">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <CheckCircle className="w-12 h-12 text-neutral-400 dark:text-neutral-400 animate-scale-in" />
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md mx-auto animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
              <div className="bg-neutral-800/40 rounded-lg p-3">
                <div className="text-2xl font-bold text-neutral-400 dark:text-neutral-400">
                  {analyzedProjects.filter(p => p.selected).length}
                </div>
