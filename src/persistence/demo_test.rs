...
async fn test_persistence_demo() {
    ...
    info!(
        "✅ Configuração de coleção criada: dimensão={}, métrica={:?}",
    ...
    info!(
        "✅ Transação criada com {} operações",
    ...
    info!(
        "✅ Checkpoint criado com sequência: {}",
        checkpoint_sequence
    );
...
async fn test_wal_performance_demo() {
    ...
    println!(
        "✅ Performance test: {} operações em {:?} ({:.2} ops/sec)",
        1000,
        duration,
