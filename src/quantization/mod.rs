...
impl QuantizationManager {
    ...
    pub fn meets_quality_requirements(&self) -> bool {
        self.stats
            .meets_quality_threshold(self.config.quality_threshold)
    }
}
...
pub use hnsw_integration::{HnswQuantizationConfig, QuantizedHnswIndex};
...
pub use traits::{
    OptimizationConfig, QualityMetrics, QuantizationMethod, QuantizationParams, QuantizedSearch,
    QuantizedVectors,
};
