...
// ============================================================================
// Extracted providers (phase4_split-embedding-providers).
// BagOfWords, CharNGram, and the EmbeddingManager facade live in sibling
// files under providers/. The interleaved providers (TfIdf, Bm25, Svd,
// Bert, MiniLm) still sit above — their extraction is tracked under
// phase4_split-embedding-providers-interleaved.
// ============================================================================
mod providers;
pub use providers::{BagOfWordsEmbedding, CharNGramEmbedding, EmbeddingManager};
