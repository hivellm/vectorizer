...
pub async fn handle_get_file_chunks_ordered(
    ...
    let result = file_ops
        ...
        .await
        .map_err(|e| {
            ErrorData::internal_error(format!("Failed to get file chunks: {}", e), None)
        })?;
...
pub async fn handle_get_project_outline(
    ...
    let result = file_ops
        ...
        .await
        .map_err(|e| {
            ErrorData::internal_error(format!("Failed to get project outline: {}", e), None)
        })?;
...
pub async fn handle_get_related_files(
    ...
    let result = file_ops
        ...
        .await
        .map_err(|e| {
            ErrorData::internal_error(format!("Failed to get related files: {}", e), None)
        })?;
...
pub async fn handle_search_by_file_type(
    ...
    let result = file_ops
        ...
        .await
        .map_err(|e| {
            ErrorData::internal_error(format!("Failed to search by file type: {}", e), None)
        })?;
