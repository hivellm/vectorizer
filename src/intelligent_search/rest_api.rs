...
impl RESTAPIHandler {
    ...
    pub fn validate_intelligent_search_request(&self, request: &IntelligentSearchRequest) -> Result<(), String> {
    ...
    pub fn validate_multi_collection_search_request(&self, request: &MultiCollectionSearchRequest) -> Result<(), String> {
        if request.query.trim().is_empty() {
            return Err("Query cannot be empty".to_string());
        }
    ...
    pub fn validate_semantic_search_request(&self, request: &SemanticSearchRequest) -> Result<(), String> {
        if request.query.trim().is_empty() {
            return Err("Query cannot be empty".to_string());
        }
    ...
    pub fn validate_contextual_search_request(&self, request: &ContextualSearchRequest) -> Result<(), String> {
        if request.query.trim().is_empty() {
            return Err("Query cannot be empty".to_string());
        }
...
impl APIDocumentation {
    ...
    pub fn get_documentation() -> HashMap<String, serde_json::Value> {
        ...
        docs.insert("version".to_string(), serde_json::Value::String("1.0.0".to_string()));
        docs.insert("title".to_string(), serde_json::Value::String("Vectorizer Intelligent Search API".to_string()));
        docs.insert("description".to_string(), serde_json::Value::String("REST API for intelligent search capabilities".to_string()));
...
mod tests {
    ...
    fn test_validate_intelligent_search_request() {
        ...
        assert!(handler.validate_intelligent_search_request(&valid_request).is_ok());
        ...
        assert!(handler.validate_intelligent_search_request(&invalid_request).is_err());
        ...
        assert!(handler.validate_intelligent_search_request(&invalid_request2).is_err());
    }
    ...
    fn test_validate_multi_collection_search_request() {
        ...
        assert!(handler.validate_multi_collection_search_request(&valid_request).is_ok());
        ...
        assert!(handler.validate_multi_collection_search_request(&invalid_request).is_err());
    }
    ...
    fn test_api_documentation() {
        ...
        assert_eq!(docs["version"], serde_json::Value::String("1.0.0".to_string()));
        assert_eq!(docs["title"], serde_json::Value::String("Vectorizer Intelligent Search API".to_string()));
    }
}
