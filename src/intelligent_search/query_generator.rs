...
impl QueryGenerator {
    ...
    fn is_technical_term(&self, word: &str) -> bool {
        ...
        let technical_terms = [
            "api", "sdk", "framework", "library", "database", "vector", "search",
            "embedding", "model", "algorithm", "index", "query", "result", "data",
            "config", "configuration", "setup", "install", "deploy", "build",
            "test", "debug", "error", "log", "performance", "optimization",
            "caching", "memory", "cpu", "gpu", "network", "http", "rest",
            "json", "xml", "yaml", "toml", "rust", "python", "javascript",
            "typescript", "node", "react", "vue", "angular", "docker", "kubernetes",
            "aws", "azure", "gcp", "github", "git", "ci", "cd", "devops",
            "microservice", "architecture", "pattern", "design", "best", "practice",
            "tutorial", "guide", "documentation", "example", "sample", "demo",
            "cmmv", "vectorizer", "hnsw", "quantization", "persistence", "mcp",
        ];
