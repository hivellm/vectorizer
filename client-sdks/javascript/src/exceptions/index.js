...
import { VectorizerError } from './vectorizer-error.js';

export { VectorizerError };
...
export class CollectionNotFoundError extends VectorizerError {
  constructor(collectionName, details = {}) {
    if (!collectionName) {
      super('Collection not found', 'COLLECTION_NOT_FOUND', details);
    } else {
...
export class SearchError extends VectorizerError {
  constructor(message = 'Search operation failed', details = {}) {
