...
import { validateCollection, validateCreateCollectionRequest } from '../../src/models/collection';
  ...
  describe('validateCollection', () => {
    ...
    it('should throw error for invalid similarity metric', () => {
      const collection = {
        name: 'test-collection',
        dimension: 384,
        similarity_metric: 'invalid' as any as any
      } as any;
    ...
    it('should validate all valid similarity metrics', () => {
      const validMetrics = ['cosine', 'euclidean', 'dot_product'] as const;
