...
- [Creating Collections](./collections/CREATING.md) - How to create collections
- [Collection Configuration](./collections/CONFIGURATION.md) - Advanced configuration options
...
- [Inserting Vectors](./vectors/INSERT.md) - Adding vectors to collections
