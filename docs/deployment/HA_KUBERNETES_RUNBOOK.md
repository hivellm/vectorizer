...
| `MasterNode failed: IO error: Address in use (os error 98)` on the leader, followers stop receiving writes | Pod regained leadership without restarting; the previous term's master still held port 7001 (release ≤ 3.7.1) | Upgrade to ≥ 3.7.2. |
