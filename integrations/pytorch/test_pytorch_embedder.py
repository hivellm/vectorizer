...
This module contains comprehensive tests for the PyTorch integration with Vectorizer.
"""
...
class TestPyTorchModelConfig:
    """Test PyTorchModelConfig class"""
    
    def test_default_config(self):
        """Test default configuration"""
        config = PyTorchModelConfig(model_path="test_model.pt")
...
class TestTransformerEmbedder:
    ...
    @patch('pytorch_embedder.AutoModel')
    @patch('pytorch_embedder.AutoTokenizer')
...
class TestCustomPyTorchEmbedder:
    """Test CustomPyTorchEmbedder class"""
    ...
    def test_load_model(self, mock_load):
        ...
        embedder = CustomPyTorchEmbedder(self.config)
...
class TestPyTorchVectorizerClient:
    """Test PyTorchVectorizerClient class"""
    
    def setup_method(self):
        """Setup test client"""
        self.client = PyTorchVectorizerClient()
...
class TestConvenienceFunctions:
    ...
    @patch('pytorch_embedder.TransformerEmbedder')
    ...
    def test_transformer_embedder_import_error(self):
        ...
        with patch.dict('sys.modules', {'transformers': None}):
            with pytest.raises(ImportError, match="transformers library is required"):
                TransformerEmbedder(PyTorchModelConfig(model_path="test"))
    
    def test_cnn_embedder_file_error(self):
        """Test CNN embedder with file error"""
        config = PyTorchModelConfig(model_path="nonexistent.pt")
...
class TestIntegration:
    ...
    def test_real_pytorch_integration(self):
        """Test real PyTorch integration with Vectorizer"""
        ...
        try:
            ...
            with patch('torch.load') as mock_load:
                ...
                embedder = CustomPyTorchEmbedder(config)
