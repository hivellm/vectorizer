...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if health_response.status().is_success() {
        ...
        println!("✅ Server is healthy: {}", serde_json::to_string_pretty(&health)?);
    } else {
    ...
    if create_response.status().is_success() {
        ...
        println!("✅ Collection created: {}", serde_json::to_string_pretty(&result)?);
    } else {
        println!("❌ Failed to create collection: {}", create_response.status());
    ...
    if list_response.status().is_success() {
        ...
        println!("✅ Collections: {}", serde_json::to_string_pretty(&collections)?);
    }
    ...
    if insert_response.status().is_success() {
        ...
        println!("✅ Vectors inserted: {}", serde_json::to_string_pretty(&result)?);
    } else {
    ...
    if search_response.status().is_success() {
        ...
        println!("✅ Search results: {}", serde_json::to_string_pretty(&results)?);
    } else {
    ...
    if get_response.status().is_success() {
        ...
        println!("✅ Vector retrieved: {}", serde_json::to_string_pretty(&vector)?);
    } else {
