...
- [x] 1.1 Expose a sync-flush API on `AutoSaveManager` (if not already
...
- [x] 1.4 Either rename `force_save_all`
...
- [x] 1.5 Confirm the compactor output path matches
...
- [x] 2.2 Write tests covering the new behavior (unit test in
