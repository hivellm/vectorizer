...
- [x] 1.2 Sweep `dashboard/`: bump Vite to the patched release of
...
- [x] 1.4 Re-check `pnpm audit` in every touched dir after the
...
- [x] 2.2 Write tests covering the new behavior (no new tests
...
- [x] 2.3 Run tests and confirm they pass (per-path commands noted
