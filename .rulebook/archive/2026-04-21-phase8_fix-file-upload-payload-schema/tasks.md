...
- [x] 1.1 In `crates/vectorizer-server/src/server/files/upload.rs`,
...
- [x] 1.2 In the shared `insert_one_text` helper at
...
- [x] 1.3 Add a dual-shape fallback in
...
- [x] 1.4 Log a DEBUG line when the flat-shape fallback fires so
