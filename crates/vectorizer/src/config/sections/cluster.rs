//! Cluster (distributed sharding) configuration data.
//!
//! Plain serde types only — `ClusterManager` construction and
//! business logic live in `crate::cluster`, which re-exports these
//! types from here (see `phase41_architecture-decoupling` §2).
