...
impl From<vectorizer::models::DistanceMetric> for GqlDistanceMetric {
    fn from(metric: vectorizer::models::DistanceMetric) -> Self {
        match metric {
            vectorizer::models::DistanceMetric::Cosine => GqlDistanceMetric::Cosine,
            vectorizer::models::DistanceMetric::Euclidean => GqlDistanceMetric::Euclidean,
            vectorizer::models::DistanceMetric::DotProduct => GqlDistanceMetric::DotProduct,
        }
    }
}

impl From<GqlDistanceMetric> for vectorizer::models::DistanceMetric {
    fn from(metric: GqlDistanceMetric) -> Self {
        match metric {
            GqlDistanceMetric::Cosine => vectorizer::models::DistanceMetric::Cosine,
            GqlDistanceMetric::Euclidean => vectorizer::models::DistanceMetric::Euclidean,
            GqlDistanceMetric::DotProduct => vectorizer::models::DistanceMetric::DotProduct,
        }
    }
}
...
impl From<vectorizer::models::StorageType> for GqlStorageType {
    fn from(storage: vectorizer::models::StorageType) -> Self {
        match storage {
            vectorizer::models::StorageType::Memory => GqlStorageType::Memory,
            vectorizer::models::StorageType::Mmap => GqlStorageType::Mmap,
        }
    }
}
...
impl From<&vectorizer::models::HnswConfig> for GqlHnswConfig {
    fn from(config: &vectorizer::models::HnswConfig) -> Self {
        Self {
            m: config.m as i32,
...
impl From<&vectorizer::models::CollectionConfig> for GqlCollectionConfig {
    fn from(config: &vectorizer::models::CollectionConfig) -> Self {
        Self {
...
impl From<vectorizer::models::CollectionMetadata> for GqlCollection {
    fn from(meta: vectorizer::models::CollectionMetadata) -> Self {
        Self {
            name: meta.name,
...
impl From<vectorizer::models::Vector> for GqlVector {
    fn from(v: vectorizer::models::Vector) -> Self {
        Self {
            id: v.id,
            data: v.data,
...
impl From<vectorizer::models::SearchResult> for GqlSearchResult {
    fn from(r: vectorizer::models::SearchResult) -> Self {
        Self {
            id: r.id,
            score: r.score,
            vector: r.vector,
...
impl From<vectorizer::db::graph::RelationshipType> for GqlRelationshipType {
    fn from(rt: vectorizer::db::graph::RelationshipType) -> Self {
        match rt {
            vectorizer::db::graph::RelationshipType::SimilarTo => GqlRelationshipType::SimilarTo,
            vectorizer::db::graph::RelationshipType::References => GqlRelationshipType::References,
            vectorizer::db::graph::RelationshipType::Contains => GqlRelationshipType::Contains,
            vectorizer::db::graph::RelationshipType::DerivedFrom => {
...
impl From<GqlRelationshipType> for vectorizer::db::graph::RelationshipType {
    fn from(rt: GqlRelationshipType) -> Self {
        match rt {
            GqlRelationshipType::SimilarTo => vectorizer::db::graph::RelationshipType::SimilarTo,
            GqlRelationshipType::References => vectorizer::db::graph::RelationshipType::References,
            GqlRelationshipType::Contains => vectorizer::db::graph::RelationshipType::Contains,
            GqlRelationshipType::DerivedFrom => {
                vectorizer::db::graph::RelationshipType::DerivedFrom
            }
        }
...
impl From<vectorizer::db::graph::Node> for GqlNode {
    fn from(n: vectorizer::db::graph::Node) -> Self {
        Self {
            id: n.id,
...
impl From<vectorizer::db::graph::Edge> for GqlEdge {
    fn from(e: vectorizer::db::graph::Edge) -> Self {
        Self {
            id: e.id,
            source: e.source,
            target: e.target,
