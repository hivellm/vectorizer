...
use vectorizer::models::qdrant::point::QdrantPointStruct;
...
use vectorizer::models::{Payload, SearchResult, Vector};
...
fn compute_similarity(a: &[f32], b: &[f32], metric: &vectorizer::models::DistanceMetric) -> f32 {
