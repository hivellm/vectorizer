...
copy "%PROJECT_ROOT%\vectorize-workspace.example.yml" "%PACKAGE_DIR%\config\"
...
echo echo   GRPC Server: http://localhost:15003 >> "%PACKAGE_DIR%\install.bat"
echo echo. >> "%PACKAGE_DIR%\install.bat"
...
echo - **GRPC Server**: http://localhost:15003 >> "%PACKAGE_DIR%\PACKAGE_README.md"
echo. >> "%PACKAGE_DIR%\PACKAGE_README.md"
...
echo - Edit `config\vectorize-workspace.yml` for workspace configuration >> "%PACKAGE_DIR%\PACKAGE_README.md"
echo. >> "%PACKAGE_DIR%\PACKAGE_README.md"
...
echo - **GRPC Server**: http://localhost:15003 >> "%RELEASE_NOTES_FILE%"
echo. >> "%RELEASE_NOTES_FILE%"
echo ## 📚 Documentation >> "%RELEASE_NOTES_FILE%"
echo. >> "%RELEASE_NOTES_FILE%"
echo - **README**: Complete documentation included in package >> "%RELEASE_NOTES_FILE%"
echo - **Configuration**: Edit `config\config.yml` and `config\vectorize-workspace.yml` >> "%RELEASE_NOTES_FILE%"
