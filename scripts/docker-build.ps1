...
if (-not $builderExists) {
    Write-Host "🔧 Creating attestation-builder..." -ForegroundColor Cyan
    docker buildx create --name attestation-builder --driver docker-container --use | Out-Null
...
if ($Push) {
    ...
    Write-Host "📤 Will push to Docker Hub after build" -ForegroundColor Yellow
    Write-Host ""
}
