...
- **TypeScript SDK**: 352+ tests (✅ Published v3.5.0)
- **Python SDK**: 184+ tests (✅ Published v3.5.0)
- **Rust SDK**: 88+ tests (✅ Published v3.5.0)
- **C# SDK**: Tests included (✅ Published v3.5.0; `Vectorizer.Sdk.Rpc` adds 54 framing/transport tests)
- **Go SDK**: Tests included (✅ Released v3.5.0)
...
| `GITHUB_TOKEN` | `sdks/go/v3.5.0` tag push | `git push origin sdks/go/v3.5.0` |
...
python -m build
twine check dist/*
twine upload dist/vectorizer-3.5.0*
```
...
dotnet nuget push bin/Release/Vectorizer.Sdk.Rpc.3.5.0.nupkg \
...
git tag sdks/go/v3.5.0
git push origin sdks/go/v3.5.0

# Verify from a clean checkout:
go install github.com/hivellm/vectorizer-sdk-go@v3.5.0
```
